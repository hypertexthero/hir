...
class Post(models.Model):
    ...
    url = models.URLField(_("Link URL"), blank=True, null=True, help_text="with or without http://", default='')
    content_markdown = models.TextField(_("Article"), blank=True, help_text="<a data-toggle='modal' href='#markdownhelp'>Markdown syntax</a>.")
