...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[\w\._\-]+)/$', 'hotinrome.apps.blog.views.user_post_list', dict(post_dict_public, template_name='blog/user_post_list.html'), name='blog_user_post_list'),
    url(r'^edit/(?P<id>\d+)/$', 'hotinrome.apps.blog.views.edit', name='blog_edit'),
    url(r'^(?P<action>draft|public)/(?P<id>\d+)/$', 'hotinrome.apps.blog.views.change_status', name='blog_change_status'),
    url(r'^delete/(?P<id>\d+)/$', 'hotinrome.apps.blog.views.delete', name='blog_delete'), 
    # =voting
    ...
    url(r'^(?P<username>[\w\._\-]+)/(?P<slug>[-\w]+)/$', 'hotinrome.apps.blog.views.blog_user_post_detail', post_dict, name='blog_user_post_detail'),
   )
